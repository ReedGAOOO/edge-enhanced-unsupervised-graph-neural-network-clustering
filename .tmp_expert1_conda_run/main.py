...
parser.add_argument('--edge_state_hidden_dim', type=int, default=128,
                    help='V40A: hidden size of the edge-state predictor.')
parser.add_argument('--edge_state_temp', type=float, default=1.0,
                    help='V40A: temperature of the edge-state simplex predictor.')
parser.add_argument('--edge_state_support_floor', type=float, default=0.15,
                    help='V40A: residual support floor when filtering message/SI graphs.')
parser.add_argument('--edge_state_support_lambda', type=float, default=1.0,
                    help='V40A: support auxiliary loss weight.')
parser.add_argument('--edge_state_boundary_lambda', type=float, default=1.0,
                    help='V40A: boundary auxiliary loss weight.')
parser.add_argument('--edge_state_conf_lambda', type=float, default=5e-3,
                    help='V40A: entropy/confidence regularizer weight.')
parser.add_argument('--edge_state_balance_lambda', type=float, default=1e-3,
                    help='V40A: marginal role-balance regularizer weight.')
parser.add_argument('--edge_state_detach_context', action='store_true',
                    help='V40A: detach leaf context before predicting edge states.')
parser.add_argument('--edge_state_use_context', dest='edge_state_use_context', action='store_true',
                    help='V40A: use endpoint context features in the edge-state predictor.')
parser.add_argument('--no_edge_state_use_context', dest='edge_state_use_context', action='store_false',
                    help='V40A: ablate endpoint context from the edge-state predictor.')
parser.add_argument('--edge_relation_use_assignment', dest='edge_relation_use_assignment', action='store_true',
                    help='V40: enable relation-aware assignment compatibility term.')
parser.add_argument('--no_edge_relation_use_assignment', dest='edge_relation_use_assignment', action='store_false',
                    help='V40: disable relation-aware assignment compatibility term.')
parser.add_argument('--edge_relation_use_si_hierarchy', dest='edge_relation_use_si_hierarchy', action='store_true',
                    help='V40: enable relation-aware SI hierarchy reweighting/persistence.')
parser.add_argument('--no_edge_relation_use_si_hierarchy', dest='edge_relation_use_si_hierarchy', action='store_false',
                    help='V40: disable relation-aware SI hierarchy reweighting/persistence.')
parser.add_argument('--edge_relation_use_msg_adj', dest='edge_relation_use_msg_adj', action='store_true',
                    help='V40: enable relation-aware message-adjacency reweighting.')
parser.add_argument('--no_edge_relation_use_msg_adj', dest='edge_relation_use_msg_adj', action='store_false',
                    help='V40: disable relation-aware message-adjacency reweighting.')
