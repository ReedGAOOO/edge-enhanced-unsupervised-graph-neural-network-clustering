...
class LSENet(nn.Module):
    def __init__(self, manifold, in_dim, hid_dim, max_nums,
        ...
        # V40A predicts edge-state outside the encoder and passes the state simplex
        # directly as edge_attr into the hierarchy/assignment trunk.
        self.edge_relation_enabled = False
